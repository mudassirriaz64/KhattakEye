              ...
              <div className="mt-6 flex gap-3">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className="flex h-10 w-10 items-center justify-center rounded-full border border-[color:var(--color-border)] text-[color:var(--color-text-secondary)] transition-all hover:-translate-y-0.5 hover:border-[color:var(--color-accent-teal)] hover:text-[color:var(--color-accent-teal)]"
              ...
              <ul className="space-y-4">
                <li>
                  <a
                    ...
                    className="flex items-center gap-3 text-sm text-[color:var(--color-text-secondary)] transition-colors hover:text-[color:var(--color-text-primary)]"
                  >
                    <Phone className="h-4 w-4 shrink-0 text-[color:var(--color-accent-teal)]" />
                ...
                <li>
                  <a
                    ...
                    className="flex items-center gap-3 text-sm text-[color:var(--color-text-secondary)] transition-colors hover:text-[color:var(--color-text-primary)]"
                  >
                    <Mail className="h-4 w-4 shrink-0 text-[color:var(--color-accent-teal)]" />
                    {footerLinks.contact.email}
                  </a>
                </li>
                <li className="flex items-start gap-3 text-sm text-[color:var(--color-text-secondary)]">
                  <MapPin className="mt-0.5 h-4 w-4 shrink-0 text-[color:var(--color-accent-teal)]" />
