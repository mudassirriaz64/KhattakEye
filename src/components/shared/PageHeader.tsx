  ...
  return (
    <div className="grid gap-6 rounded-[32px] border border-[color:var(--color-border)] bg-[color:var(--color-panel)] px-6 py-7 shadow-[var(--shadow-soft)] lg:grid-cols-[1fr_auto] lg:px-8 lg:py-9">
      <motion.div
        ...
        className="space-y-4"
      >
        <div className="inline-flex items-center gap-2 rounded-full border border-[color:var(--color-border-strong)] bg-white/80 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.28em] text-[color:var(--color-text-secondary)] dark:bg-white/5">
      ...
      {aside ? (
        <div className="flex flex-col justify-between rounded-[28px] border border-white/70 bg-[linear-gradient(145deg,rgba(255,255,255,0.98),rgba(248,249,250,0.94))] p-5 shadow-[var(--shadow-soft)] dark:border-white/10 dark:bg-[linear-gradient(145deg,rgba(18,18,20,0.95),rgba(12,12,14,0.92))] lg:w-[320px]">
          {aside}
        </div>
      ) : (
        <div className="hidden lg:flex lg:w-[320px] lg:flex-col lg:justify-between lg:rounded-[28px] lg:border lg:border-[color:var(--color-border)] lg:bg-[linear-gradient(145deg,rgba(17,17,17,0.03),rgba(37,99,235,0.02))] lg:p-5 dark:lg:bg-[linear-gradient(145deg,rgba(255,255,255,0.02),rgba(20,184,166,0.05))]">
