...
const supportOptions = [
  { icon: MessageCircle, label: "WhatsApp", href: "https://wa.me/1234567890", color: "text-green-500" },
  ...
  return (
    <div className="fixed bottom-24 right-6 z-40 md:bottom-6">
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="flex h-12 w-12 items-center justify-center rounded-full bg-[color:var(--color-accent-teal)] text-white shadow-[var(--shadow-strong)] transition-colors hover:bg-[#115E59]"
