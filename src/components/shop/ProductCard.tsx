        ...
        <div className={cn("flex flex-1 flex-col p-4", isList ? "justify-center" : "")}>
          ...
          <div className={cn("mt-auto flex gap-2", isList ? "mt-4" : "")}>
            ...
            <button
              ...
              className="flex items-center gap-1.5 rounded-xl bg-[color:var(--color-accent-teal)] px-3 py-2.5 text-xs font-semibold text-white transition-all hover:bg-[#115E59]"
            >
