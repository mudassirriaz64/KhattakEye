...
export const categories: Category[] = [
  {
    ...
    image: ei("luxury sunglasses product photography on marble surface, premium studio lighting, editorial fashion ecommerce, realistic detail"),
  ...
  },
  {
    ...
    image: ei("luxury prescription eyewear on premium surface, elegant studio lighting, professional optical fashion, realistic"),
  ...
  },
  {
    ...
    image: ei("luxury titanium eyewear floating on dark surface, premium studio lighting, editorial product photography, realistic metal details"),
    path: "/shop/titanium",
    count: "18 Styles",
  },
  {
    ...
    image: ei("modern blue light blocking glasses on tech-inspired surface, premium product photography, studio lighting, realistic"),
