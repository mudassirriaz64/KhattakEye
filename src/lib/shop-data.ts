...
export const filterGroups: FilterGroup[] = [
  {
    ...
    type: "checkbox",
    options: [
      { label: "Sunglasses", value: "sunglasses", count: 42 },
      { label: "Prescription", value: "prescription", count: 28 },
      { label: "Blue Light", value: "blue-light", count: 24 },
      { label: "Reading Glasses", value: "reading", count: 15 },
      { label: "Sports eyewear", value: "sports", count: 12 },
    ],
  },
  {
    id: "brand",
    ...
    type: "checkbox",
    options: [
      { label: "Khattak Atelier", value: "khattak-atelier", count: 18 },
      { label: "Khattak Signature", value: "khattak-signature", count: 22 },
      { label: "Khattak Heritage", value: "khattak-heritage", count: 15 },
      { label: "Khattak Performance", value: "khattak-performance", count: 10 },
    ],
  },
  {
    id: "gender",
    ...
    type: "checkbox",
    options: [
      { label: "Men", value: "men", count: 35 },
      { label: "Women", value: "women", count: 38 },
      { label: "Unisex", value: "unisex", count: 20 },
    ],
  },
  {
    id: "frame-shape",
    ...
    type: "checkbox",
    options: [
      { label: "Round", value: "round", count: 15 },
      { label: "Square", value: "square", count: 18 },
      { label: "Rectangle", value: "rectangle", count: 12 },
      { label: "Aviator", value: "aviator", count: 10 },
      { label: "Cat Eye", value: "cat-eye", count: 8 },
      { label: "Geometric", value: "geometric", count: 6 },
    ],
  },
  {
    id: "frame-material",
    ...
    type: "checkbox",
    options: [
      { label: "Titanium", value: "titanium", count: 20 },
      { label: "Acetate", value: "acetate", count: 25 },
      { label: "Stainless Steel", value: "stainless-steel", count: 12 },
      { label: "Carbon Fiber", value: "carbon-fiber", count: 8 },
    ],
  },
  {
    id: "lens-type",
    ...
    type: "checkbox",
    options: [
      { label: "Polarized", value: "polarized", count: 20 },
      { label: "Blue Light Blocking", value: "blue-light-blocking", count: 24 },
      { label: "Photochromic", value: "photochromic", count: 10 },
      { label: "Progressive", value: "progressive", count: 8 },
      { label: "Anti-Reflective", value: "anti-reflective", count: 30 },
    ],
  },
  {
    id: "lens-color",
    ...
    type: "checkbox",
    options: [
      { label: "Black", value: "black", count: 22 },
      { label: "Brown", value: "brown", count: 15 },
      { label: "Green", value: "green", count: 12 },
      { label: "Blue", value: "blue", count: 10 },
      { label: "Grey", value: "grey", count: 8 },
      { label: "Mirror", value: "mirror", count: 6 },
    ],
  },
  {
    id: "frame-color",
