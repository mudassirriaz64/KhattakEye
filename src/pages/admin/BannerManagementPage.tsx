...
export function AdminBannerManagementPage() {
  ...
  const typeColors: Record<string, string> = { slider: "bg-[color:var(--color-accent-blue)]/10 text-[color:var(--color-accent-blue)]", offer: "bg-emerald-500/10 text-emerald-600", popup: "bg-purple-500/10 text-purple-600", seasonal: "bg-amber-500/10 text-amber-600" };
